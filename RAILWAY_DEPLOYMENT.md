# Railway Deployment Guide for Stock Pilot Server

Kini nga giya mag-tudlo kanimo kung unsaon pag-deploy sa Stock Pilot Central Server sa Railway para sa cloud access ug syncing.
...
3.  Pilia ang imong `Stock_Pilot` repository.
...
3.  Sa parting **Public Networking**, i-click ang **Generate Domain** para makakuha ka ug public URL (pananglitan: `https://stockpilot.up.railway.app`).
...
3.  Ibutang ang imong Railway Public URL sa field nga **API Endpoint** (Siguroha nga naay `/api` sa tumoy kung gikinahanglan sa imong server logic, pananglitan: `https://stockpilot.up.railway.app/api`).
