...
import type { PrinterFormat } from './use-x-reading-page';

interface Props {
  isOpen: boolean;
  onClose: () => void;
  selectedReading: XReadingData;
...
export function XReadingPreviewModal({ isOpen, onClose, selectedReading, printerFormat, setPrinterFormat, businessSettings, previewRef, onPrint }: Props) {
