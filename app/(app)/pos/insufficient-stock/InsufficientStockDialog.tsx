...
import type { InsufficientStockDialogProps } from './insufficient-stock-types';

export function InsufficientStockDialog({ open, onOpenChange, items }: InsufficientStockDialogProps) {
  return (
