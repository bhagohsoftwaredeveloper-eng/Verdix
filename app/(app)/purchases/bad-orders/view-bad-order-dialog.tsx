          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm font-semibold">{badOrder.warehouseName || '-'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-muted-foreground">Shelf / Area</p>
                <p className="text-sm font-semibold">{badOrder.shelfName || '-'}</p>
              </div>
              <div>
