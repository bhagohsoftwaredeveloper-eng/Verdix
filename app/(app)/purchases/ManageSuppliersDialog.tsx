...
function SupplierRow({ supplier, onUpdateSupplier, onDeleteSupplier }: { supplier: Supplier, onUpdateSupplier: (name: string, contactNumber: string) => void, onDeleteSupplier: () => void }) {
  const { toast } = useToast();

  const handleUpdate = async (name: string, contactNumber: string) => {
    onUpdateSupplier(name, contactNumber);
    toast({
...
export function ManageSuppliersDialog({ trigger }: { trigger?: React.ReactNode }) {
                        ...
                        <SupplierRow
                          ...
                          onUpdateSupplier={(name, contactNumber) => {
                            setSuppliers(prev => prev.map(s =>
                              s.id === supplier.id ? { ...s, name, contactNumber } : s
                            ));
                          }}
                          onDeleteSupplier={() => {
