            ...
            <div className="space-y-5 my-2">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">
                  Variances to Apply ({itemsWithVariances.length})
                </h3>
                {itemsWithVariances.length === 0 ? (
                  <p className="text-muted-foreground text-sm">
                    All counted items match their snapshot exactly. No stock adjustments will be
                    made.
                  </p>
                ) : (
                  <>
                    ...
                    <div className="flex flex-col gap-2 sm:hidden">
                      {itemsWithVariances.map((item) => {
                        const variance =
                          (item.counted_quantity ?? 0) - item.snapshot_quantity;
                        return (
                          <div
                            key={item.id}
                          ...
                          >
                            <div className="min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground">
                                Expected: {item.snapshot_quantity} → Counted:{' '}
                                {item.counted_quantity}
                              </p>
                            </div>
                            <span
