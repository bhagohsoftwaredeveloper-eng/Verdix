                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={(value) => field.onChange(parseInt(value))} defaultValue={field.value?.toString()}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="100">Basic (100 points)</SelectItem>
                            <SelectItem value="250">Silver (250 points)</SelectItem>
                            <SelectItem value="500">Gold (500 points)</SelectItem>
                            <SelectItem value="1000">Platinum (1000 points)</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage />
                      </FormItem>
